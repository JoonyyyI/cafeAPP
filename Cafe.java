...
@Getter
@Setter
public class Cafe {  /*** 카페 정보 종류 ***/
	
	private String cafeName;  /** 카페 이름 **/
	
	private String cafeLocation;  /** 카페 위치 **/
    
    private String cafeOpen;  /** 카페 오픈 시간 **/
	
	private String cafeClose;  /** 카페 클로즈 시간 **/
	
	private String cafeNo;  /** 카페 전화번호 **/
	
	private String cafeSM;  /** 카페 스토어 매니저 **/
	
	private char cafeDelivery;  /** 카페 딜리버리 가능여부 **/ 
